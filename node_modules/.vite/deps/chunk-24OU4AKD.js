...
var SelectInput = React82.forwardRef(function SelectInput2(props, ref) {
  ...
  const displayRef = React82.useRef(null);
  const [displayNode, setDisplayNode] = React82.useState(null);
  const {
    current: isOpenControlled
  } = React82.useRef(openProp != null);
  const [menuMinWidthState, setMenuMinWidthState] = React82.useState();
  const handleRef = useForkRef_default(ref, inputRefProp);
  const handleDisplayRef = React82.useCallback((node) => {
  ...
  React82.useImperativeHandle(handleRef, () => ({
    focus: () => {
  ...
  return (0, import_jsx_runtime60.jsxs)(React82.Fragment, {
...
var Select3 = React84.forwardRef(function Select4(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  return (0, import_jsx_runtime62.jsx)(React84.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-24OU4AKD.js.map
